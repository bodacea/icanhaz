...
Expects to find a file, ../secrets.txt, with a row containing twitter,overcognition,keys where keys is from Twitter: 
...
"""
def get_trend(twitter_api, placeid=1):
	place_trends = twitter_api.trends.place(_id=trendid)
	return(place_trends)
